...
import '../MainContentComponents/ContactMe.scss';
...
export default function ContactMe() {
  ...
  return (
    <section className="contact-page flex column center">
      <h2 className="contact-header">Ready for your dream site? Inquire below!</h2>
      <form className="flex column center" ref={form} onSubmit={sendEmail}>
        <div>
