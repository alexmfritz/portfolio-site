...
export default function About() {
  return (
    <section className="about-page">
      <img className="about-image-left" src={climbOne} alt="climbing"/>
      <h2 className="about-header fade-in-one">About Me</h2>
      <p className="about-story fade-in-two">
      ...
      <img className="about-image-right" src={wedding} alt="wedding"/>
      <p className="about-story fade-in-three">
      ...
      <p className="about-story fade-in-four">
      ...
      <p className="about-closer fade-in-five">
        Thanks for checking out my page! -Alex
      </p>
    </section>
  )
}